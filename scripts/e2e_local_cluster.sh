...
./build/rstone-cli --endpoint 127.0.0.1:18080 put e2e:key value
value="$(./build/rstone-cli --endpoint 127.0.0.1:18080 get e2e:key)"
if [ "$value" != "value" ]; then
  echo "unexpected value: $value" >&2
  exit 1
fi

./build/rstone-cli --endpoint 127.0.0.1:18080 delete e2e:key
if ./build/rstone-cli --endpoint 127.0.0.1:18080 get e2e:key >/tmp/rstone_e2e_get.out 2>/tmp/rstone_e2e_get.err; then
...
./build/rstone-cli --endpoint 127.0.0.1:18080 put banana yellow
transfer_value="$(./build/rstone-cli --endpoint 127.0.0.1:18080 get banana)"
...
./build/rstone-cli --endpoint 127.0.0.1:18080 put cherry red
membership_value="$(./build/rstone-cli --endpoint 127.0.0.1:18080 get cherry)"
...
left_value="$(./build/rstone-cli --endpoint 127.0.0.1:18080 get apple)"
right_value="$(./build/rstone-cli --endpoint 127.0.0.1:18080 get zebra)"
